...
$from_email = 'support@rem-comp.top';
$from_name = 'support@rem-comp.top';
$to_email = 'Spprtdmnservice@gmail.com';
...
$form['form1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма - узнать стоимость ремонта',
		'title' => 'Форма - узнать стоимость ремонта',
		'ajax' => true,
		'validate' => true,
		...
		'antispam' => '',
		'antispamjs' => '',
		'okay' => 'Сообщение успешно отправлено! Мы Вам перезвоним в ближайшее время.'
	)
);
...
$form['form2'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма - заказ консультации',
		'title' => 'Форма - заказ консультации',
		'ajax' => true,
		'validate' => true,
		'from_email' => $from_email,
		'from_name' => $from_name,
...
$form['form3'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма - Получить консультацию (другие неисправности)',
		'title' => 'Форма - Получить консультацию (другие неисправности)',
		'ajax' => true,
		'validate' => true,
		'from_email' => $from_email,
		'from_name' => $from_name,
...
$form['form4'] = array(
	...
	'cfg' => array(
		...
		'title' => 'Форма - заказ обратного звонка',
		'ajax' => true,
		'validate' => true,
		'from_email' => $from_email,
		'from_name' => $from_name,
...
$form['form6'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Форма - вопрос мастеру',
		'title' => 'Форма - вопрос мастеру',
		'ajax' => true,
		'validate' => true,
		'from_email' => $from_email,
		'from_name' => $from_name,
